...
from sentinel.domain.common import Confidence, Identifier, SentinelModel, Severity, new_id, utcnow
...
class HttpMessage(SentinelModel):
...
class Observation(SentinelModel):
    ...
    title: str
    vuln_class: str = Field(description="Sentinel canonical class, see findings.taxonomy")
    severity: Severity
...
class UnifiedFinding(SentinelModel):
    ...
    title: str
    category: str = Field(description="Sentinel canonical vulnerability class")
    severity: Severity
