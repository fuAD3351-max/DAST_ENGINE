...
Native adapters run Vantage's own detectors. They fetch only through an
...
from vantage.adapters.http import HttpClient, ScopedHttpClient
...
FIRST_PARTY_LICENSE = "LicenseRef-Vantage-Proprietary"
