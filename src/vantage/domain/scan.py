...
from vantage.domain.engine import Capability
...
class PlannedTask(VantageModel):
...
class PlanStage(VantageModel):
    kind: StageKind
    tasks: list[PlannedTask] = Field(default_factory=list)


class ScanPlan(VantageModel):
    scan_id: str
